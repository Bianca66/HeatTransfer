...
echo -e "Rulare static\v" >> final_ibm.txt
...
for j in {1..10}
do
        echo -e "N_Threads = $j \v" >> final_ibm.txt
...
echo -e "Rulare static Chunk = 4\v" >> final_ibm.txt
...
echo -e "Rulare static Chunk = 8\v" >> final_ibm.txt
...
echo -e "Rulare static Chunk = 16\v" >> final_ibm.txt
...
echo -e "Rulare static Chunk = 32\v" >> final_ibm.txt
...
echo -e "Rulare static Chunk = 64\v" >> final_ibm.txt
...
echo -e "Rulare dynamic\v" >> final_ibm.txt
...
echo -e "Rulare dynamic Chunk = 4\v" >> final_ibm.txt
...
echo -e "Rulare dynamic Chunk = 8\v" >> final_ibm.txt
...
echo -e "Rulare dynamic Chunk = 16\v" >> final_ibm.txt
...
echo -e "Rulare dynamic Chunk = 32\v" >> final_ibm.txt
...
echo -e "Rulare dynamic Chunk = 64\v" >> final_ibm.txt
...
echo -e "Rulare guided\v" >> final_ibm.txt
...
echo -e "Rulare guided Chunk = 4\v" >> final_ibm.txt
...
echo -e "Rulare guided Chunk = 8\v" >> final_ibm.txt
...
echo -e "Rulare guided Chunk = 16\v" >> final_ibm.txt
...
echo -e "Rulare guided Chunk = 32\v" >> final_ibm.txt
...
echo -e "Rulare guided Chunk = 64\v" >> final_ibm.txt
...
echo -e "Rulare guided auto\v" >> final_ibm.txt
